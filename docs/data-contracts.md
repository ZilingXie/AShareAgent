...
当前状态：已落地第一版 domain models、provider 契约、真实 DataCollector 入口、PostgreSQL 初始 schema、核心 pipeline 持久化、策略参数版本审计、DashboardQueryAgent 只读 DTO 契约、复盘指标 DTO 和 dashboard API DTO。
